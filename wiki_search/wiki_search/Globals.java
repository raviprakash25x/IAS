...
public class Globals {
	...
	static String[] stpWrdArr={ "without", "see", "unless", "due", "also", "must", "might", "like", "]", "[", "}", "{",
			...
			"this", "the", "many", "any", "an", "or", "for", "in", "an", "an ", "is", "a", "about", "above", "after",
			...
			"yours", "yourself", "yourselves", "Without", "See", "Unless", "Due", "Also", "Must", "Might", "Like", "Will",
			"May", "Can", "Much", "Every", "The", "In", "Other", "This", "The", "Many", "Any", "An", "Or", "For", "In",
			"An", "An ", "Is", "A", "About", "Above", "After", "Again", "Against", "All", "Am", "An", "And", "Any", "Are",
	...
	public static void populateStopWords() {
		...
		for(int i=0; i<stpWrdArr.length; i++) {
			stopwords.add(stpWrdArr[i]);
		}
	} 
